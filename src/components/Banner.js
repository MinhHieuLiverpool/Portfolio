            ...
            <TrackVisibility>
              {({ isVisible }) =>
                <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                  ...
                  <a href={require('../assets/MinhHieuCV.pdf' )}  download style={{ textDecoration: 'none' }}>
                    <button>Download CV <ArrowRightCircle size={25} /></button>
                  </a>
                
                  {/* <a href="https://www.bqminhhieu.id.vn/assets/MinhHieuCV.pdf"  target="_blank" download style={{ textDecoration: 'none' }}>
                    <button>Download CV <ArrowRightCircle size={25} /></button>
                  </a> */}
                </div>}
            </TrackVisibility>
